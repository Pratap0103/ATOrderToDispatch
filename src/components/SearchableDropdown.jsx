          ...
          <div className="p-1.5 border-b border-gray-100 bg-gray-50 flex gap-1.5 items-center">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full bg-white border border-gray-200 rounded pl-7 pr-2 py-1 text-xs focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500/20 shadow-inner"
              />
            </div>
          </div>
