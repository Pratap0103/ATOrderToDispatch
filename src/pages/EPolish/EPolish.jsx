...
import EPolishPending from './EPolishPending';
...
const EPolish = () => {
  ...
  // Split orders based on E-Polish status
  // 1. Pending: Ghat Jama completed as "E-Polish" OR (completed as "Meena Inhouse" and routed to "E-Polish") and E-Polish status is NOT complete/processed
  

  // 2. History: processed E-Polish orders (has ePolishStatus value)
