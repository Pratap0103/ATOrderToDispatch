...
const DispatchEdit = ({ isOpen, onClose, onSave, order }) => {
  ...
  return (
    <ModalForm
      isOpen={isOpen}
      onClose={onClose}
      title={`Edit Dispatch Details — Order: ${order.orderNo || order.orderNumber}`}
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <CustomDropdown
              ...
              onChange={(val) => handleInputChange({ target: { name: 'dispatchStatus', value: val } })}
