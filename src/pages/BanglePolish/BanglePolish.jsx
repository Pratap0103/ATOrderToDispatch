...
import BanglePolishPending from './BanglePolishPending';
...
const BanglePolish = () => {
  ...
  const baseHistoryOrders = useMemo(() => {
    return orders.filter(o => 
      o.banglePolishStatus && 
      o.banglePolishStatus !== 'Pending' && 
      o.banglePolishStatus !== ''
    );
  }, [orders]);
  ...
  // Split orders based on Bangle Polish status
  // 1. Pending: Ghat Jama completed as "Bangle Polish" OR (completed as "Meena Inhouse"/"Meena Outside" and routed to "Bangle Polish") and Polish status is NOT complete/processed
  

  // 2. History: processed Bangle Polish orders (has banglePolishStatus value)
