...
const BanglePolishForm = ({ isOpen, onClose, onSave, order }) => {
  ...
  const handleSubmit = (e) => {
    ...
    onSave({
      ...
      banglePolishTimestamp: new Date().toISOString(),
    });
  ...
  return (
    <ModalForm
      isOpen={isOpen}
      onClose={onClose}
      title={`Bangle Polish — Order: ${order.orderNo || order.orderNumber}`}
      onSubmit={handleSubmit}
      submitText="Save Bangle Polish"
      cancelText="Cancel"
      maxWidth="max-w-xl"
      maxHeight="90vh"
    >
...
export default BanglePolishForm;
